/**
 * QuarterlySummaryHub.tsx
 *
 * Per-quarter summary component. Horizontal Q1-Q4 tabs show income, allowable
 ...
 *
 * WHY: Extracted from mtdQuarterlySummary.tsx to keep the screen file as pure composition.
 *
 * Depends on: hooks/mtd/useMtdData, hooks/mtd/useMtdTransactionsForQuarter,
 *             utils/mtdCategories, utils/mtdTaxCalc, utils/invoiceSync
...
import { useMtdTransactionsForQuarter, MtdTransactionRow } from '@/hooks/mtd/useMtdTransactionsForQuarter';
...
export default function QuarterlySummaryHub() {
  ...
  const expenseRows = useMemo(() => {
    ...
    return EXPENSE_CATEGORIES.filter((cat) => cat !== 'turnover').map((cat) => ({
      ...
      amount: (aggregates as Record<string, unknown>)[cat] as number,
