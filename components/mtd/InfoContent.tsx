 ...
 * InfoContent.tsx
 *
 * MTD reference and help component. Read-only — no forms, no DB calls.
 * Shows tax year info, quarterly deadlines, tax rates, useful links,
 * and invoicing tips.
 *
 * WHY: Extracted from info.tsx to keep the screen file as pure composition.
 *
 * Depends on: context/ThemeContext, utils/mtdTaxCalc, utils/mtdDates
 * Used by: app/(drawer)/info.tsx
 */
