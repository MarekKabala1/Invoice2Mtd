/**
 * AddMtdTransactionForm.tsx
 *
 * Form component for adding manual MTD income or expense records.
 * Uses react-hook-form + zodResolver with newMtdTransactionSchema.
 * Falls back to the date's quarter automatically.
 *
 * WHY: Extracted from addMtdTransaction.tsx to keep the screen file as pure composition.
 *
 * Depends on: hooks/mtd/useMtdTransaction, db/zodSchema,
 *             utils/mtdCategories, utils/mtdDates
...
export default function AddMtdTransactionForm() {
