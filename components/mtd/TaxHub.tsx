 ...
 * TaxHub.tsx
 *
 * MTD hub component. Shows current quarter stats, next deadline,
 * and navigation tiles to all MTD features. Reads quarterlyTaxEnabled from
 * appSettings to show enrolment state when disabled.
 *
 * WHY: Extracted from tax.tsx to keep the screen file as pure composition.
 *
 * Depends on: hooks/mtd/useMtdData, hooks/mtd/useMtdDeadlines, hooks/invoice/useUnpaidInvoicesForQuarter,
 *             hooks/mtd/useMtdDataAllQuarters, context/AppSettingsContext, utils/mtd/mtdDates, utils/mtd/mtdTaxCalc
 * Used by: app/(drawer)/(tabs)/tax.tsx
 */
...
import { useMtdData } from '@/hooks/mtd/useMtdData';
import { useMtdDeadlines } from '@/hooks/mtd/useMtdDeadlines';
import { useUnpaidInvoicesForQuarter } from '@/hooks/invoice/useUnpaidInvoicesForQuarter';
import { useMtdDataAllQuarters } from '@/hooks/mtd/useMtdDataAllQuarters';
...
import { useTaxRates } from '@/hooks/mtd/useTaxRates';
