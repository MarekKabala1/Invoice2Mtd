 ...
 * ChartsHub.tsx
 *
 * Invoice charts component. Shows line chart of monthly/individual invoice amounts
 * and summary totals for a selected user.
 *
 * WHY: Extracted from charts.tsx to keep the screen file as pure composition.
 *
 * Depends on: hooks/invoice/useChartsData, components/ui/Picker, components/ui/BaseCard, context/ThemeContext
 * Used by: app/(drawer)/charts.tsx
 */
...
import { useChartsData } from '@/hooks/invoice/useChartsData';
