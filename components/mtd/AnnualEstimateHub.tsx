/**
 * AnnualEstimateHub.tsx
 *
 * SA103-style Self Assessment summary component. Aggregates all 4 quarters,
 ...
 *
 * WHY: Extracted from mtdAnnualEstimate.tsx to keep the screen file as pure composition.
 *
 * Depends on: hooks/mtd/useMtdDataAllQuarters, utils/mtdTaxCalc, utils/mtdDates,
 *             utils/mtdCategories, components/ui/TaxBandBar
...
import { TaxBandBar } from '@/components/ui/TaxBandBar';
...
export default function AnnualEstimateHub() {
