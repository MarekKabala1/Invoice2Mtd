...
export default function TaxScreen() {
  ...
  const topExpenses = useMemo(() => {
    ...
    return EXPENSE_ONLY_CATEGORIES
      .map((cat) => ({
        category: cat,
  ...
  return (
    ...
    >
      ...
      <View
        ...
        style={{ backgroundColor: isDark ? '#312e81' : '#4f46e5' }}
      >
        <View className="flex-row items-center justify-between">
          <Text className="text-2xl font-bold text-white">Tax</Text>
          <View
            className="px-3 py-1 rounded-full"
            style={{ backgroundColor: isDark ? 'rgba(255,255,255,0.2)' : 'rgba(255,255,255,0.15)' }}
          >
            ...
            <View className="flex-row gap-3">
              ...
              >
                ...
                <Text
                  ...
                  style={{ color: (aggregates?.netProfit ?? 0) >= 0 ? '#39AD6A' : '#ee1c1c' }}
                >
